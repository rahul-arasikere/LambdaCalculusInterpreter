...
implement fprint_val<t0erm> = fprint_t0erm
implement fprint_val<t0dcl> = fprint_t0dcl

(* ****** ****** *)

implement print_t0erm(tm) = fprint_t0erm(stdout_ref, tm)
...
implement print_t0pgm(pgm) = fprint_t0pgm(stdout_ref, pgm)
