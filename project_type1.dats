...
(* ****** ****** *)
implement type1_new_ext() = T1Pext(tpext_new())
...
local
  ...
  (
    ...
    (
      case+ t1p2 of
      | T1Pfun(t1p21, t1p22) => type1_unify(t1p11, t1p21) && type1_unify(t1p12, t1p22) 
      | _ => false
    )
    | T1Ptup(t1p11, t1p12) =>
    (
      case+ t1p2 of
      | T1Ptup(t1p21, t1p22) => type1_unify(t1p11, t1p21) && type1_unify(t1p12, t1p22) 
      | _ => false
    )
  )
in
...
implement print_type1(tm) = fprint_type1(stdout_ref, tm)
