...
in
  implement t2ins_emit (out, t2m0) =
    (case- t2m0 of
      | T2INSmov (tmp, val1) => (fprint!( out
                                        , tmp
                                        , "="
                                        , redefine_t2val(val1)
                                        , ";\n"
                                        ))
      | T2INSclo (tmp, fname, tvalst, tllst) => (let
      ...
      | T2INSsub (tmp, val1) => (fprint!( out
                                        , "lamval "
                                        , tmp
                                        , " = "
                                        , "LAMOPR_isub( LAMVAL_int(0), "
                                        , redefine_t2val(val1)
                                        , ");\n"
                                        ))
      | T2INSneg (tmp, val1) => (fprint!( out
                                        , "lamval "
                                        , tmp
                                        , " = "
                                        , "LAMOPR_neg("
      ...
      | T2INSprint (tmp, val1) => (fprint!( out
                                          , "LAMVAL_print("
                                          , redefine_t2val(val1)
                                          , ");\n"
                                          ))
      | T2INSiadd (tmp, val1, val2) => (fprint!( out
                                               , "lamval "
                                               , tmp
                                               , " = "
                                               , "LAMOPR_iadd("
      ...
      | T2INSisub (tmp, val1, val2) => (fprint!( out
                                               , "lamval "
                                               , tmp
                                               , " = "
                                               , "LAMOPR_isub("
      ...
      | T2INSimul (tmp, val1, val2) => (fprint!( out
                                               , "lamval "
                                               , tmp
                                               , " = "
                                               , "LAMOPR_imul("
      ...
      | T2INSidiv (tmp, val1, val2) => (fprint!( out
                                               , "lamval "
                                               , tmp
                                               , " = "
                                               , "LAMOPR_idiv("
      ...
      | T2INSimod (tmp, val1, val2) => (fprint!( out
                                               , "lamval "
                                               , tmp
                                               , " = "
                                               , "LAMOPR_imod("
      ...
      | T2INSneq (tmp, val1, val2) => (fprint!( out
                                              , "lamval "
                                              , tmp
                                              , " = "
                                              , "LAMOPR_ineq("
      ...
      | T2INSeq (tmp, val1, val2) => (fprint!( out
                                             , "lamval "
                                             , tmp
                                             , " = "
                                             , "LAMOPR_ieq("
      ...
      | T2INSlt (tmp, val1, val2) => (fprint!( out
                                             , "lamval "
                                             , tmp
                                             , " = "
                                             , "LAMOPR_ilt("
      ...
      | T2INSlte (tmp, val1, val2) => (fprint!( out
                                              , "lamval "
                                              , tmp
                                              , " = "
                                              , "LAMOPR_ilte("
      ...
      | T2INSgt (tmp, val1, val2) => (fprint!( out
                                             , "lamval "
                                             , tmp
                                             , " = "
                                             , "LAMOPR_igt("
      ...
      | T2INSgte (tmp, val1, val2) => (fprint!( out
                                              , "lamval "
                                              , tmp
                                              , " = "
                                              , "LAMOPR_igte("
      ...
      | T2INStup (tmp, val1, val2) => (fprint!( out
                                              , "lamval "
                                              , tmp
                                              , " = "
                                              , "LAMVAL_clo("
      ...
      | T2INScall (tmp, val1, val2) => (fprint!( out
                                               , "lamval "
                                               , tmp
                                               , " = "
                                               , "LAMVAL_call("
      ...
      | T2INScond (tmp, val1, t2lst1, t2lst2) => (let
        val () = fprint!(out, "lamval ", tmp, ";\n")
        val () = fprint!( out
                        , "if( ((lamval_int)"
                        , redefine_t2val(val1)
